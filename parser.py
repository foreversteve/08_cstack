...
The file follows the following format:
	 ...
	 The commands are as follows:
		 ...
		 push: push a copy of the current top of the coordinate system csystems to the csystems

		 pop: pop off the current top of the coordinate system csystems

		 All the shape commands work as follows:
			 1) Add the shape to a temporary matrix
			 2) Multiply that matrix by the current top of the coordinate system csystems
...
def parse_file( fname, edges, polygons, csystems, screen, color ):
	...
	while c < len(lines):
		...
		if line == 'sphere':
			...
			#copy the top of csystems
			b = copy.deepcopy(csystems[-1])
